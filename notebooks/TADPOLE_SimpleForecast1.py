...
errorFlag = 0
if not os.path.exists(tadpoleLB1LB2File):
    print('File {0} does not exist! \nYou need to generate it using makeLeaderboardDataset.py'.format(
      tadpoleLB1LB2File))
    errorFlag = 1
if errorFlag:
    sys.exit()
...
DXCHANGE = LB_Table.DX.values.copy() # 'NL to MCI', 'MCI to Dementia', etc.
...
RID_Col = LB_Table.RID.values.copy()
...
EXAMDATE = LB_Table.EXAMDATE.values.copy()
